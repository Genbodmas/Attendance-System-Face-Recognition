...
for (dirpath, dirnames, filenames) in os.walk('C:/Users/Gen Bodmas/PycharmProjects/2nfFaceAttendance/Images/'):
    known_faces_filenames.extend(filenames)
    break

for filename in known_faces_filenames:
    face = face_recognition.load_image_file('C:/Users/Gen Bodmas/PycharmProjects/2nfFaceAttendance/Images/' + filename)
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.putText(frame, name, (left + 6, bottom - 6), font, 1.0, (0, 255, 0), 2)
